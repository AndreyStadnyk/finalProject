insert into `users` (username, first_name, last_name, address, gender, password) values ('VPupkin', 'Vasya', 'Pupkin', 'New York', 'male', 'qwerty');
insert into `users` (username, first_name, last_name, address, gender, password) values ('PMatroskin', 'Petya', 'Matroskin', 'Wuhan','male', '12345');
