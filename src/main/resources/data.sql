...
insert into `users` (username, first_name, last_name, address, gender, password) values ('PMatroskin', 'Petya', 'Matroskin', 'Wuhan','mail', '12345');
 ...
 --insert into `posts` (username_author, username_owner, text) values ('PMatroskin', 'PMatroskin', 'Some text from owner and author Matroskin');
-- insert into `posts` (username_author, username_owner, text) values ('PMatroskin', 'VPupkin', 'Some text from owner Pupkin and author Matroskin');
